  ...
  return (
    <div className={styles.container}>
      ...
      <header className={styles.header}>
        {home ? (
          <>
            <Image priority src="/images/profile.png" className={utilStyles.borderCircle} height={64} width={64} alt="Profile Icon" />
          </>
        ) : (
          <>
            <Link href="/">
              <Image priority src="/images/profile.png" className={utilStyles.borderCircle} height={48} width={48} alt="Profile Icon" />
            </Link>
          </>
        )}
      </header>
