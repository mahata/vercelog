...
『[Software Engineering at Google](https://learning.oreilly.com/library/view/software-engineering-at/9781492082781/)』の第三章は「Knowledge Sharing」というタイトルだ。これを読んだ感想を書いてみる。

知識共有は重要だ。多くの人も同じように認識していることだろう。しかし、これが善意によって妨げられることがある、という話は面白いと思った。たとえば、エース級の人材が難しいタスクを「あ、じゃあ僕がやっておきます」とこなしてしまうのは、その人からすれば善意なんだろうけど、知識がチームに根付かないという意味では悪手である。

じゃあ知っている人がドキュメントを書くようにすればいいのかと言うと、それが最善とは言えない場合もある。[アジャイルソフトウェア開発宣言](https://agilemanifesto.org/iso/ja/manifesto.html)には「プロセスやツールよりも個人と対話を」「包括的なドキュメントよりも動くソフトウェアを」という節がある。それぞれ別なことを言っているけど、あわせて僕は「ドキュメントよりも、対話しながらソフトウェアを一緒に動かす」ことが多くの場合はベストなのではないかと考えている。この「一緒に動かす」というのはペアプログラミングを意識していて、つまりエクストリーム・プログラミングが知識共有に最も効くのでは、ということだ。

反論があるとすれば、スケールメリットだろう。ドキュメントは一度書いたら何度も読んでもらえる。ペアプログラミングはペアにしか知識が伝播しない。とはいえ、ペアをローテーションすることはエクストリーム・プログラミングのプラクティスでもあるし、ローテーションさせ続けることで必要な人に知識を行き渡らせることは難しくないのではないかと思う。なんなら *ペアで* ドキュメントを書いても良い。

本章では質問者の無知に対して「feigned surprise (驚いたふり)」をしてはならない、とある。心理的安全性を低めるからだ。スタックについて質問した人に「えっ、スタックを知らないの?」と返されてしまうような環境では、安心して質問をすることは難しい、という例が紹介されていた。仮に現職で「スタックを知らない」と同僚から言われたら「驚いたふり」じゃなくて、普通にかなりびっくりしちゃう気がするけど、少なくとも言葉や態度に出さないように気をつけたい。

ところで、この辺りについては若かりし頃の苦い思い出がある。僕は 20 才前後の頃に学習塾でアルバイトをしていた。中学生向けの理科の授業のとき、16方位 (方角を 16 分割して呼ぶ方法: 北北東、東北東、など) を教えるため、まず東西南北について生徒と話した。僕が「こっちが北だとすると、反対側は何かな?」と生徒に聞いたら、その子が「東...かな?」と答えた。僕は驚いて「えっ!」と声をあげてしまった。東西南北を知らない中学生がいるなんて...というのは、当時の僕には驚きだった。

その後、その子を塾で見ることはなくなった。退塾したとのことだ。

この件に関して直接的な苦情を受け取ったわけではないし、何か他の理由で退塾したのかもしれない。でも、僕自身はこのときの自分の態度を悔いているし、たまに思い出して反省している。なんにせよ、僕が彼の心理的安全性を低めたことに変わりはないだろう。

さて、他に本章で面白かったことと言えば「シニアであることと "何でも知っていること" を混同するな」「質問をすることで、他の人も質問しやすくなる」というような話だ。僕は後者については意図的にそう振る舞っている。特に場が静まり返っているときほど質問をすることで、他の人が声をあげやすいようにしている。その意味で、知っていることを聞くことさえある。こういう所作を肯定してもらえるのは嬉しく思う。
